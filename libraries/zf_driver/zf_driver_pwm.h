...
typedef enum // 枚举 PWM 通道 此枚举定义不允许用户修改
{
    ...
    PWM1_MODULE3_CHB_B11 = 1 * 40 + 5 * 6,
    PWM1_MODULE3_CHB_C17,
    PWM1_MODULE3_CHB_D1, // PWM1 子模块3 通道B  引脚可选范围
    PWM1_MODULE3_CHA_B10 = 1 * 40 + 5 * 7,
    PWM1_MODULE3_CHA_C16,
    PWM1_MODULE3_CHA_D0, // PWM1 子模块3 通道A  引脚可选范围
    ...
    PWM2_MODULE3_CHB_B1 = 2 * 40 + 5 * 6,
    PWM2_MODULE3_CHB_C19,
    PWM2_MODULE3_CHB_D3, // PWM2 子模块3 通道B  引脚可选范围
    PWM2_MODULE3_CHA_B0 = 2 * 40 + 5 * 7,
    PWM2_MODULE3_CHA_C18,
    PWM2_MODULE3_CHA_D2,
    PWM2_MODULE3_CHA_B9, // PWM2 子模块3 通道A  引脚可选范围
